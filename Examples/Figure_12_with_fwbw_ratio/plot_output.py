...
subplot1 = plt.subplot2grid((5, 1), (4, 0), rowspan=1, colspan=1)
subplot2 = plt.subplot2grid((5, 1), (0, 0), rowspan=3, colspan=1)
subplot3 = plt.subplot2grid((5, 1), (3, 0), rowspan=1, colspan=1)
...
#fig.align_ylabels([subplot2,subplot3,subplot1])
#fig.tight_layout
